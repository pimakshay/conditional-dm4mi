...
def conv2d(
    ...
    conv = nn.Conv2d(
        in_channel, out_channel, kernel_size, stride=stride, padding=padding, bias=bias, dilation=dilation
    )
...
class ResBlock(nn.Module):
    def __init__(
        self, in_channel, out_channel, time_dim, use_affine_time=False, dropout=0, dilation=1
    ):
        super().__init__()
        ...
        self.conv2 = conv2d(out_channel, out_channel, 3, padding="same", dilation=dilation, scale=1e-10)
...
class ResBlockWithAttention(nn.Module):
    def __init__(
        ...
        self.resblocks = ResBlock(
            in_channel, out_channel, time_dim, use_affine_time, dropout, dilation
        )
...
class Unet(nn.Module):
    def __init__(
        ...
        dilated_down, dilated_mid, dilated_up = dilation
